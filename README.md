...
- Upgrade `husky` considering `Migrating from husky 4`.
- [@commitlint/config-conventional](https://github.com/conventional-changelog/commitlint/tree/master/%40commitlint/config-conventional#commitlintconfig-conventional) does not work as expected. RE: https://github.com/conventional-changelog/commitlint